...
package com.xxxxx.xxxxxxxx.project.filters;

import com.xxxxx.xxxxxxxx.project.models.RequestContext;
import com.xxxxx.xxxxxxxx.project.models.enums.ServiceScope;
...
public class InternalInvokeFilter implements Filter {
    ...
    private static final String basePath = "/xxxxx/v1";
    private static final String internalBasePath = basePath + "/inner";
    ...
    public void doFilter(ServletRequest servletRequest, ServletResponse servletResponse,
        ...
        filterChain.doFilter(new HttpServletRequestWrapper(httpServletRequest) {
            ...
            public String getServletPath() {
                ...
                return basePath + httpServletRequest.getServletPath()
                                        .substring(internalBasePath.length());
            }
        }, servletResponse);
    }
}
